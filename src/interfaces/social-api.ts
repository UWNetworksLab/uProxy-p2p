...
export interface NetworkState {
  name     :string;
  profile  :uproxy_types.UserProfileMessage;
  roster   :{[userId :string] :uproxy_types.UserMessage};
}
...
export interface Network {
  ...
  roster     :{[userId:string]:user.BaseUser};
   ...
   */
  getUser :(userId :string) => user.BaseUser;
   ...
   * will reject.
   */
  send :(user :user.BaseUser, clientId:string, msg:PeerMessage)
      => Promise<void>;
