...
module Core {
  export class RemoteConnection { //TODO I think this should probably implement some stuff
    ...
    private sendUpdate_ :(x :uProxy.Update, data?:any) => void;

    constructor(
      sendUpdate :(x :uProxy.Update, data?:any) => void
    ) {
