...
/// <reference path='../../third_party/freedom/rtcdatachannel.d.ts' />
...
//
class DataChannelClass implements DataChannels.Channel {
  ...
  //     browser object.
  public static createFromFreedomId(id:string) : Promise<DataChannels.Channel> {
