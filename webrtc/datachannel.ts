...
export class DataChannelClass implements DataChannel {
  ...
  // The binaryType is set to arraybuffer for those platforms where
  // Blob is the default (unsupported by Freedom).
  // |id| is the GUID generated by Freedom to identify the underlying
  //     browser object.
  public static createFromFreedomId(id:string) : Promise<DataChannel> {
