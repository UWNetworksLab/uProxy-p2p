...
function updateWithRelease {
  ...
  git add bower.json package.json src/chrome/app/manifest.json src/chrome/extension/manifest.json src/chrome/app/managed_policy_schema.json src/firefox/package.json
